...
namespace RecordMyStats.DataAccess.Data.Vitals
{
    public class PostgresVitalsRepository : IVitalsRepository
    {
        ...
        private string AddMemberQueryString = @"INSERT INTO public.Member
                                       (FirstName
                                       ,LastName
                                       ,MiddleName
                                       ,IsActive
        ...
        private string AddStatisticEntryQueryString = @"INSERT INTO public.StatisticEntry
                                       (MemberId
                                       ,CreateDate
                                       ,BloodSugar
                                       ,Weight
        ...
        private string AddNoteEntryQueryString = @"INSERT INTO public.Note
                           (Description
                           ,FullText
                           ,Created
                           ,ModBy
        ...
        private string AddQuestionEntryQueryString = @"INSERT INTO public.Question
                           (QuestionText
                           ,ExplanationText
                           ,MultipleAnswers
                           ,IsActive
        ...
        private string UpdateQuestionQueryString = @"UPDATE public.Question
                        SET QuestionText = @QuestionText, ExplanationText = @ExplanationText
                        WHERE Id = @Id;";

        private string AddAnswerQueryString = @"INSERT INTO public.Answer
                           (AnswerText
                           ,IsCorrect
                           ,IsActive
                           ,QuestionId)
        ...
        private string AddBloodSugarEntryQueryString = @"INSERT INTO public.BloodSugar
                               (MemberId
                               ,Value
                               ,Units
                               ,WhenTaken
        ...
        private string AddBloodPressureEntryQueryString = @"INSERT INTO public.BloodPressure
                               (MemberId
                               ,RecordingDate
                               ,Systolic
                               ,Diastolic
        ...
        private string UpdateSessionsDeactivate = @"UPDATE public.Session
                                       SET IsActive = FALSE 
                                        where MemberId = @MemberId AND IsActive = TRUE";

        private string GetMemberByEmailQueryString = "SELECT id, FirstName, LastName from public.Member where Email = @Email";
        ...
        private string GetMemberIdBySessionKeyQueryString = "SELECT MemberId, ExpiresDate, IsActive from public.Session where SessionKey = @SessionKey and IsActive = TRUE";

        private string GetMemberByEmailAndPasswordQueryString = "SELECT id, FirstName, LastName from public.Member where Email = @Email and Password = @Password";

        private string GetAllMembersQueryString = "SELECT id, FirstName, LastName, Email, Sex, Zip, IsActive, MiddleName from public.Member ";

        private string CreateSessionInsertSql = @"INSERT INTO public.Session
                       (MemberId
                       ,SessionKey
                       ,CreateDate
                       ,ExpiresDate
